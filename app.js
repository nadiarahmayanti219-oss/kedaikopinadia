...
const NAMA_KEDAI = "KEDAI KOPI NADIA";
...
let namaPelanggan = prompt("Masukkan nama Anda:");   // ← WAJIB ada ini dulu
...
console.log("=== MENU BESTSELLER UNTUK MEMBER ===");
for (let i = 0; i < menubestseller.length; i++) {
console.log((i + 1) + ". " + menubestseller[i]);
}
...
console.log("Total Menu Favorit: " + menubestseller.length + " menu");
console.log("=== YUKS MAMPIR KEDAI KOPI NADIA HEHEHE! ===");